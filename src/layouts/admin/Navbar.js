...
const Navbar = () => {
    ...
    return (
        <nav className="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <ul className="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0 navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li className="nav-item dropdown">
                    <Link to="#" className="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false"><i className="fas fa-user fa-fw"></i>
                    </Link>
