        ...
        axios.post(`/api/store-product`, formData)
            .then(res => {
                if (res.data.status === 200) {
                    ...
                    if (document.getElementById('popular_checkbox').checked) {
                        document.getElementById('popular_checkbox').checked = false;
                    };

                    if (document.getElementById('featured_checkbox').checked) {
                        document.getElementById('featured_checkbox').checked = false;
                    };
                    ...
                    setProductInput({ ...productInput, errorList: res.data.message })
                }
            }).catch(error => {
                console.error(error)
            })
                            ...
                            <div className="tab-pane card-body bordered fade" id="otherdetails" role="tabpanel" aria-labelledby="otherdetails-tab">
                                <div className="row">
                                    ...
                                    <div className="col-md-8 col-sm-12 form-group mb-3">
                                        <label>Image</label>
                                        <input onChange={handleImage} type="file" name="image" id="upload_image" className="form-control" required />
                                    </div>
